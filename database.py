...
def init_db(
    ...
    CREATE TABLE senses (id INTEGER PRIMARY KEY, enabled INTEGER, lemma_id INTEGER, pos TEXT, short_def TEXT TEXT DEFAULT '', full_def TEXT TEXT DEFAULT '', example TEXT TEXT DEFAULT '', difficulty INTEGER, FOREIGN KEY(lemma_id) REFERENCES lemmas(id));
    """
